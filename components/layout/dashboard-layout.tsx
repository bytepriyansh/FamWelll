...
export function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-blue-50 to-pink-50">
      ...
      variant="ghost"
      size="sm"
      className="flex items-center gap-2 rounded-2xl border px-4 py-2 shadow-sm hover:bg-gray-100"
    >
      <span className="text-gray-600 text-sm font-medium">Family Invite Code:</span>
      <span className="px-2 py-1 rounded-md bg-gray-900 text-white text-sm font-mono tracking-wider">
        {fwCode}
      </span>
    </Button>
            </div>
